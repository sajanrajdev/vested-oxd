...
contract MockStrategy is BaseStrategy {
    ...
    function _harvest() internal virtual override returns (TokenAmount[] memory harvested) {}

    function _isTendable() internal pure virtual override returns (bool) {}

    function _tend() internal virtual override returns (TokenAmount[] memory tended) {}
